...
namespace ReflectionDemo
{
    ...
    class Program {
        ...
        static void Main(string[] args)
        {
            ...
            if (a is A)
            {
                Console.WriteLine("a is object of A class");
            }
            if (b is A)
            {
                Console.WriteLine("b is in A because derived from A");
            }
            if (a is B)
            {
                Console.WriteLine("This wont dislay as a is not derived from B");

            }
            // suppose i want to types of .net framework asssembes 
            ...
            if (t.IsAbstract)
            {
                Console.WriteLine("it is abstract class");
            }
            else
            {
                Console.WriteLine("it is concrete class");
            }
            Type tt = typeof(MyClass);
            Console.WriteLine($"chekcing methods in {tt.Name}");
