...
namespace StringBuildfunctions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //here chars means index property

            Console.WriteLine($"chars means indxing if" + $"i use like this then chars only it means [] : {str[1]}");
            ...
            Console.WriteLine($"Insert : {str.Insert(5, "Beautiful")}");
            Console.WriteLine($"Remove :{str.Remove(3, 6)}");
            ...
            Console.WriteLine($"Equals :{str2.Equals(str3)}");
